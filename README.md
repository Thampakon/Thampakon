### Objective
**บัญชีนี้ไว้เรียนรู้, พัฒนาทักษะ และแจกความรู้ที่พอมีประโยชน์ เช่น CTF, Code, Cyber Security, Tool และอื่นๆซึ่งเป็นภาษาไทยและENG โดยผมจะเลือกมาเป็นอย่างดี แต่เนื้อหาเรื่อง code น้อยหน่อยเพราะผมเน้นไปที่ Malware ซึ่งมันค่อนข้างอันตราย หากมีคนที่เจอปัญหาเพราะ Malware ผมเลยอาจไม่ได้ลงงานเขียน code ส่วนตัว**
